...
In this study, multiple text representation are explored, such as tokens/lemmas (Section~\ref{sec:tokens_lemmas}), letters n-grams (Section~\ref{sec:letters_n_grams}) and short sequences of POS (Section~\ref{sec:pos_short_sequences}).
