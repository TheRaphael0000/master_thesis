\subsection{Most Frequent Approach}

The first method used to represent and compare the documents is called: Most frequent (MF), and try to compare documents by creating feature vectors containing frequencies of the most frequent items in a text representation (TR).
