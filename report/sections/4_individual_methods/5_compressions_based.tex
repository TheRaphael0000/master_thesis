...
The implementations for these compression algorithm are the ones in the Python standard library, the programming language used for this study~\cite{python_standard_library}.
...
The average time of the three runs are in Table~\ref{tab:compression_evaluation_times} when run on a desktop computer with an Intel(R) Core(TM) i7-5820K CPU @ 3.30GHz.
