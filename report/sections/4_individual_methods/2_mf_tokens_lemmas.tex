...
\subsubsection{MF Tokens and Lemmas evaluation}
...
The four token-based retained rank list from the St-Jean corpus are used, see Table~\ref{tab:rls_st_jean} in annex.
