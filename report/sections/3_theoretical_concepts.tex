...
This section contain basic notions commonly used in the authorship attribution, authorship verificatio and authorship clustering.
Some of the definitions in this sections are an adapted version of the ones in~\cite{savoy_stylo},~\cite{kocher_linking},~\cite{bcubed}.
