...
\subsubsection{Every tokens vectors}

This experiment aim to show the importance limiting the maximal number of words when creating the vector representing the author.
The whole corpus vocabulary is used to create the MFW-vector.


\begin{table}
  \centering
  \caption{Rank lists average precision using every tokens on the distances metrics and datasets.}
  \label{}

  \subcaption{Without Z-score}
  \label{}
  \begin{tabular}{l c c c|c}
    \toprule
    Metric & Oxquarry & Brunet & St-Jean & Mean \\
    \midrule
    Manhattan & 0.62 & 0.66 & 0.71 & \textbf{0.66} \\
    Tanimoto  & 0.62 & 0.66 & 0.71 & \textbf{0.66} \\
    Euclidean & 0.50 & 0.62 & 0.62 & 0.58 \\
    Matusita  & 0.60 & 0.64 & 0.61 & 0.61 \\
    Clark     & 0.60 & 0.44 & 0.46 & 0.50 \\
    Cosine    & 0.51 & 0.57 & 0.60 & 0.56 \\
    KLD       & 0.57 & 0.61 & 0.55 & 0.58 \\
    JD        & 0.58 & 0.64 & 0.57 & 0.59 \\
    \midrule
    Mean      & 0.57 & 0.60 & 0.60 & 0.59 \\
    \bottomrule
  \end{tabular}

  \subcaption{With Z-score}
  \label{}
  \begin{tabular}{l c c c|c}
    \toprule
    Metric & Oxquarry & Brunet & St-Jean & Mean \\
    \midrule
    Manhattan & 0.38 & 0.26 & 0.19 & 0.27 \\
    Tanimoto  & 0.14 & 0.11 & 0.04 & 0.10 \\
    Euclidean & 0.30 & 0.20 & 0.08 & 0.19 \\
    Matusita  & 0.25 & 0.19 & 0.10 & 0.18 \\
    Clark     & 0.17 & 0.10 & 0.06 & 0.11 \\
    Cosine    & 0.93 & 0.71 & 0.71 & \textbf{0.78} \\
    KLD       & 0.13 & 0.08 & 0.03 & 0.08 \\
    JD        & 0.13 & 0.08 & 0.03 & 0.08 \\
    \midrule
    Mean      & 0.30 & 0.22 & 0.16 & 0.23 \\
    \bottomrule
  \end{tabular}
\end{table}
