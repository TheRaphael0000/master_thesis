...
Aswell as basic metric to evaluate simple properties of a corpus.

\begin{definition}[Document / Text]
  A document or a text $X_i$ is a ordered list of token.
...
\begin{definition}[Author]
  An author $Y_j$ is a string describing the author.
