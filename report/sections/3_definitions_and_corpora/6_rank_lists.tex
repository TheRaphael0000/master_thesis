...
\begin{example}
  ...
  \begin{subexample}{\linewidth}
    \centering
    \subcaption{Rank list for distances' matrix from Example~\ref{ex:distances_matrix_mx}\label{ex:distances_matrix_rl}}
    \begin{tabular}{l c r}
      \toprule
  ...
  \begin{subexample}{\linewidth}
    \centering
    \subcaption{Distances' matrix for rank list from Example~\ref{ex:distances_matrix_rl}\label{ex:distances_matrix_mx}}
