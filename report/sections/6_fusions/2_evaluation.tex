...
\begin{example}
  ...
  In this example the fused rank list have a gain in average precision with the metric Single-Max.
  This indicate that fusing these rank list produce an even better result than any individual rank list.
\end{example}
