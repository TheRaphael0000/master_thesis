\subsection{Individual rank lists strategies \label{sec:eval_rl}}
...
\begin{table}
  ...
  \subcaption{Baseline every token}
  ...
  \subcaption{Gain without hapax legomena}
