...
\textbf{Automated unsupervised authorship analysis using evidence accumulation clustering (2011)}
\textit{Robert Layton, Paul Watters and Richard Dazeley},
...
% \bibitem{french_words}
% \textbf{Do What You Love community},
% \textit{Github repository of the French words} : \url{https://github.com/Vinetos/french-words-dictionary} (last access: 19.04.2021),
% Github.com
