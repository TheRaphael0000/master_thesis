\subsection{Regression-based clustering \label{sec:regression-based_clustering}}
...
To evaluate the regression-based clustering approach: Oxquarry, Brunet, St-Jean A and B were used.
