...
Which will either affect improve the $B^3_{recall}$ or the $B^3_{precision}$ when evaluating the clustering.
...
This imprecision is caused by the fact that the rank list live in a discrete space, and the score in a continuous space.
...
To evaluate the regression-based clustering approach: Oxquarry, Brunet, St-Jean A and B corpora were used.
