...
The experiment is done again for each linkage criterion.

The results are presented in Table~\ref{tab:regression-based_clustering}.
The results are aggregated using the arithmetic mean on the $B^3_{F_1}$ and $r_{diff}$ on all retained rank list per corpus.
